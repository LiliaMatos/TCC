...
namespace PortariaInteligente.Controllers
{
    public class SalasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SalaID,SalaNome,QtdLugares")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalaID,SalaNome,QtdLugares")] Sala sala)
        {
            if (id != sala.SalaID)
            {
                return NotFound();
